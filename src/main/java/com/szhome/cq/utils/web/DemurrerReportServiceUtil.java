...
public class DemurrerReportServiceUtil extends BaseServiceUtil {
	
  	
	 static DemurrerReportServiceUtil demurrerreportServiceUtil  = null;
	 public static DemurrerReportServiceUtil getInstance() {
			if(demurrerreportServiceUtil == null) {			
				demurrerreportServiceUtil 	= new DemurrerReportServiceUtil();				
			}
