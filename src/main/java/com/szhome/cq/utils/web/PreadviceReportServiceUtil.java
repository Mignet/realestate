...
public class PreadviceReportServiceUtil extends BaseServiceUtil {
	
  	
	 static PreadviceReportServiceUtil demurrerreportServiceUtil  = null;
	 public static PreadviceReportServiceUtil getInstance() {
			if(demurrerreportServiceUtil == null) {			
				demurrerreportServiceUtil 	= new PreadviceReportServiceUtil();				
			}
