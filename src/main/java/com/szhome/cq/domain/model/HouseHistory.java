...
@Component
@Entity
@Table(name = "EST_HOUSE_HIS")
public class HouseHistory extends BaseDomain<HouseHistory> {
	@Id
	private String house_his_id;
	...
	public HouseHistory(){
		super();
		this.t = HouseHistory.class;
	}

	public HouseHistory(String house_his_id){
		super();
		this.house_his_id = house_his_id;
	}

	public void setHouse_his_id(String house_his_id) {
		this.house_his_id = house_his_id;
	}
