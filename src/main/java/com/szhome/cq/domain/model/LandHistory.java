...
@Component
@Entity
@Table(name = "est_parcel_his")
public class LandHistory extends BaseDomain<LandHistory> {
	@Id
	private String parcel_his_id;
	...
	public LandHistory(){
		super();
		this.t = LandHistory.class;
	}

	public LandHistory(String parcel_his_id){
		super();
		this.parcel_his_id = parcel_his_id;
	}

	public void setParcel_his_id(String parcel_his_id) {
		this.parcel_his_id = parcel_his_id;
	}
	...
	public void setUse_per(double use_per) {
	...
	public String getParcel_his_id() {
		return parcel_his_id;
	}
