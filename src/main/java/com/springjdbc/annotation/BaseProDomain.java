 ...
 * 例子如下：
 *@Component
public class Procedure1Domain extends BaseProDomain {
	public Procedure1Domain(){
		super("P_TEST.readmeun");
	}

}
 */
public class BaseProDomain implements Serializable {
	...
	public BaseProDomain() {

	}

	public BaseProDomain(String procedureName) {
