...
<head>
    ...
    <script type="text/javascript" src="${ctx}/js/bookmanage/realestateinfoinquiry/propertyright_bi_inquiry.js"></script>
...
<body class="plui-layout">
    <div data-options="region:'center'" border=false>
		<div class="plui-layout" fit=true>
						  ...
						  <!--   <tr><td colspan=2><input type="hidden" name="queryCondition" value="user_name like ?"/></td></tr>
							...
							<tr>
								...
								<td >
								 ...
								 <th>房屋坐落：</th>
								<td><input type="text" name="sovo.address" /></td>
							</tr>
							<tr>
								<th>项目：</th>
								<td >
								...
								<th>转移方式：</th>
								<td>
								    <input type="text" name="sovo.shiftmode"/>
								</td>
							</tr>
							<tr>
								<th>楼名及栋号：</th>
								<td >
									<input type="text" name="sovo.nameandno" /> 
								</td>
								<th>权利人身份证号码：</th>
								<td>
			...
			<div data-options="region:'center',border:false">
				<table id="propertyrightBILst"></table>
			</div>
			<div id="printdiv" style="text-align:right;">
				<span style="margin-left:7px;margin-right:7px;"><a class="plui-linkbutton" href="javascript:;" iconCls='icon-print' id="propertyright_print">打 印</a></span>
			</div>
		</div>
	</div>
</body>
