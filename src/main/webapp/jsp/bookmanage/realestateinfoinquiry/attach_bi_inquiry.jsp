...
<head>
    ...
    <script type="text/javascript" src="${ctx}/js/bookmanage/realestateinfoinquiry/attach_bi_inquiry.js"></script>
...
<body class="plui-layout">
    <div data-options="region:'center'" border=false>
		<div class="plui-layout" fit=true>
						  ...
						  <!--   <tr><td colspan=2><input type="hidden" name="queryCondition" value="user_name like ?"/></td></tr>
							...
							<tr>
								...
								<td >
								 ...
								 <th>查封机关：</th>
								<td><input type="text" name="sovo.disoff" /></td>
							</tr>
							<tr>
							    <th>查封文件：</th>
								<td >
								    <input type="text" name="sovo.disfile" />
								 </td>
								 <th>查封文号：</th>
								<td><input type="text" name="sovo.disno" /></td>
							</tr>
							<tr>
							    <th>查封时间：</th>
								<td >
								 ...
								 <th>查封范围：</th>
								<td><input type="text" name="sovo.disrange" /></td>
							</tr>
							<tr>
							    <td colspan=3>&nbsp;</td>
								<td>
			...
			<div data-options="region:'center',border:false">
				<table id="attachBILst"></table>
			</div>
			<div id="printdiv" style="text-align:right;">
				<span style="margin-left:7px;margin-right:7px;"><a class="plui-linkbutton" href="javascript:;" iconCls='icon-print' id="attach_print">打 印</a></span>
			</div>
		</div>
	</div>
</body>
