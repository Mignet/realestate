...
<head>
    ...
    <script type="text/javascript" src="${ctx}/js/bookmanage/realestateinfoinquiry/easement_bi_inquiry.js"></script>
...
<body class="plui-layout">
    <div data-options="region:'center'" border=false>
		<div class="plui-layout" fit=true>
						 ...
						 <table id="mytable">
						  <!--   <tr><td colspan=2><input type="hidden" name="queryCondition" value="user_name like ?"/></td></tr>
							...
							<tr>
								<th>地役权设定情况：</th>
								<td >
									<input type="text" name="sovo.easesetitem" /> 
								</td>
								<th>房地产证号：</th>
								<td>
			...
			<div data-options="region:'center',border:false">
				<table id="easementBILst"></table>
			</div>
			<div id="printdiv" style="text-align:right;">
				<span style="margin-left:7px;margin-right:7px;"><a class="plui-linkbutton" href="javascript:;" iconCls='icon-print' id="easement_print">打 印</a></span>
			</div>
		</div>
	</div>
</body>
