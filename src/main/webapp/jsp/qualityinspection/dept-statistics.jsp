...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
    	...
    	<script type="text/javascript" src="${ctx}/js/qualityinspection/dept-statistics.js"></script> 
         <style type="text/css">
...
<body>
        ...
        <table id="tab_reg_info" style="width: 100%;margin-top:30px;margin-left:20px;">
				...
				<tr>
					...
					<td class="td_2" colspan="3"><input  id="dept" name="dept"  class="plui-validatebox input" /></td>
			...
			<div id="print" style="clear:both;">
				<div style="text-align:center;">
					<h2><label id="title">科室办文质量检查情况统计表</label></h2>
				</div>
