...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
    	...
    	<script type="text/javascript" src="${ctx}/js/qualityinspection/user-statistics.js"></script> 
         <style type="text/css">
...
<body>
        ...
        <table id="tab_reg_info" style="width: 100%;margin-top:30px;margin-left:20px;">
				...
				<tr>
					<td class="title bg1">督查员：</td>
					<td class="td_2" colspan="3"><input  id="user" name="user"  class="plui-validatebox input" /></td>
			...
			<div style="padding-right:100px;">
				<input type="button" id="btn_print" value="打印" onclick="doPrint('print')" style="float:right;"/>
			</div>
			<div id="print" style="clear:both;">
				...
				<div style="text-align:center;">
					<label style="margin-right:200px;">科室：</label>
					<label>督查员：</label>
				</div>
