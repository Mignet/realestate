...
<html>
  <head>
	...
	{
		window.open('avatar.action?uid=<%=Math.round(Math.random() * 900) + 100 + ""%>&uploadtype=head','图片上传','height=253,width=450,status=no,toolbar=no,menubar=no,location=no,scrollbars=no,resizable=no');
	}
	</script>
  </head>
