...
<script type="text/javascript" src="${ctx}/js/mortgage/mortcanacc.js"></script>
</head>
<body class="body_set">
	...
	<div data-options="region:'center',border:true">	 
		...
		<div class="datagrid-wrap panel-body">
			...
			<table class="edit_table" style="width: 100%;">
				...
				<tr>
					<td class="title bg1" style="width:200px;">注销抵押日期：</td>
					<td class="td_1"><input value="" id="CAN_MORT_DATE" name="CAN_MORT_DATE" style="width:200px;" class="plui-validatebox input" disabled="disabled"/></td>
					
				</tr>
				<tr>
					<td class="title bg1" style="width:200px;">注销原因：</td>
					<td colspan="3" scope="col">
					<textarea value="" id="CAN_MORT_REASON"  onKeyDown="limitLength(this,400)" onKeyUp="limitLength(this,400)" onPaste="limitLength(this,400)"
							name="CAN_MORT_REASON" style="height:80px;width:600px;font-size:14px"></textarea>	
	                 </td>
				</tr>
