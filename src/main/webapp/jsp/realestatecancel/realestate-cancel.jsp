...
<script type="text/javascript" src="${ctx}/js/realestatecancel/realestate-cancel.js"></script>
</head>
<body class="body_set">
<div  class="plui-layout" style="width:100%;height:100%;">  
	<div data-options="region:'center',border:true">	 
		...
		<div class="datagrid-wrap panel-body">
			...
			<div>
            <div style="background-color: rgb(224, 236, 255);line-height:18px" class="panel-header">
		          &nbsp;<label style="font-size: 12px;font-weight: bold;">注销原因</label>
		        </div> 
		        <div class="datagrid-wrap panel-body">
		      <table id="tab_reason" style="width: 100%;">
		         <tr>
              <td colspan="4" scope="col" >
					<textarea value="" id="REASON"
							name="REASON" style="height:80px;width:100%;font-size:14px"></textarea>
	             </td>
               </tr>   
		     </table>
