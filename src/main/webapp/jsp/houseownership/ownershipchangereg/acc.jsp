...
<script type="text/javascript" src="${ctx}/js/houseownership/ownershipchangereg/acc.js"></script>
<script type="text/javascript" src="${ctx}/js/houseownership/ownershipchangereg/acc-holder.js"></script>
</head>
<body  class="body_set">
		...
		<div class="datagrid-wrap panel-body">
			...
			<table class="edit_table" style="width: 100%;">
				...
				<tr>
                    ...
                    <td class="td_1"><input  id="HOUSE_ATTR" name="HOUSE_ATTR" style="width:200px;" class="plui-combodict" code="021" />
					</td>
				</tr>
				-->
				<!-- 
            ...
            <table id="table_user"></table>
		     ...
		     <div id="change_div_header" class="panel-header">
		          &nbsp;<label style="font-size: 12px;font-weight: bold;">变更内容</label>
		        </div> 
		        <div class="datagrid-wrap panel-body">
		     	...
		     	<!-- <table width="100%" id="table_holder_cbx">
                <div id="div_change_holder_detail"></div> -->
                <jsp:include page="acc-holder.jsp" flush="false"/>
		     </div>
		     </div>
		     <!-- 
