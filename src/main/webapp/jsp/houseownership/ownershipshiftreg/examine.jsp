...
<script type="text/javascript" src="${ctx}/js/houseownership/ownershipshiftreg/examine.js"></script>
			...
			<table  >
				<tr>
					...
					<th width="65" scope="col">
							...
							<input type="button" name="Submit"  id="csfjsc" value="附件" onclick="uploadFile('初审')" />
							<!-- 
							<input type="button" name="Submit"  id="csfjsc" value="附件查看" onclick="getUploadFile('初审')"/>
							 -->
						</th>
				</tr>
				<tr >
			...
			<table >
				<tr>
					...
					<th width="65" scope="col">
							...
							<input type="button" name="Submit"  id="fsfjsc" value="附件" onclick="uploadFile('复审')" />
							
							<!-- 
							<input type="button" name="Submit"  id="fsfjsc" value="附件查看" onclick="getUploadFile('复审')"/>
							 -->
						</th>
				</tr>
				<tr >
			...
			<table >
				<tr>
					...
					<th width="65" scope="col">
							...
							<input type="button" name="Submit"  id="hjfjsc" value="附件" onclick="uploadFile('核准')" />
							
							<!-- 
							<input type="button" name="Submit"  id="hjfjsc" value="附件查看" onclick="getUploadFile('核准')"/>
							 -->
						</th>
				</tr>
				<tr >
