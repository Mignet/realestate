		...
		<form id="dictclass_edit_form" method="post">
			...
			<table class="formtable">
				...
				<tr>
					...
					<td><input name="dic_type_value" type="text" /></td>
					<td class="title" style="width:100px;">分类代码：</td>
					<td><input name="dic_type_code" type="text" /></td>
				</tr>
				
				<tr>
					<td class="title">备注：</td>
					<td colspan="3">
						<textarea name="dic_type_des" rows="5" style="width:400px;"></textarea>
					</td>
				</tr>
			</table>
		</form>
