		...
		<form id="dictclass_add_form"  method="post">
			<table class="formtable">
				<tr>
					...
					<td><input name="dict_type_value" class="plui-validatebox" data-options="required:true" /></td>
					<td class="title">分类代码：</td>
					<td><input name="dict_type_code" class="plui-validatebox" data-options="required:true" /></td>
				</tr>
				
				<tr>
					<td class="title">备注：</td>
					<td colspan="3">
						<textarea name="dict_type_des" rows="5" style="width:400px;"></textarea>
					</td>
				</tr>
			</table>
		</form>
