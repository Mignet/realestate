...
<%@ include file="/base/taglibs.jsp"%>
  ...
  <script type="text/javascript" src="${ctx}/js/common/officeconfig/editOfficeConfig.js"></script>	
		...
		<div class="datagrid-wrap panel-body">
			<table class="edit_tab" style="width:100%;">
				<tr>
					...
					<td class="td_1"><select id="selectbustype" style="width:150px;" disabled="disabled"> 
					</select></td>
