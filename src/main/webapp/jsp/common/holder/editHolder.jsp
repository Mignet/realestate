...
<script type="text/javascript" src="${ctx}/js/common/holder/editHolder.js"></script>
    </head>
    <body>
    	<div class="plui-panel" data-options="fit:true,border:false">
    		<div style="width:688px;height:310px;">
	    		<div class="col1">
			    	<form id="edit_holder_form" method="post">    	
	        ...
	        <div style="text-align:center">
	            ...
	            <a id="cancel" class="plui-linkbutton" iconCls="icon-undo" onclick="closeInTopWindow('edit_holder_win');">取消</a>
		    </div>
	    </div>
    </body>
</html>
