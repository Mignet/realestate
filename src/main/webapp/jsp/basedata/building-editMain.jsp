...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
	  ...
	  <script type="text/javascript" src="${ctx}/js/basedata/building-editMain.js"></script>
    ...
    <body>
      <div id="editmain" fit=true border=false style="margin:0;">
          <div title="基本信息" type="frame" href="building-edit.jsp" data-options="args:args"></div>
