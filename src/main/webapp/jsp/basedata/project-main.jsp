...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript" src="${ctx}/js/basedata/project-main.js"></script>
...
<body class="plui-layout">
	<div data-options="region:'north',border:false" style="height:40px;">
	    ...
	    <form id="simpleform" class="searchrow" method="post">    	
	    	<input type="hidden" name="queryCondition" value="project_name like ?"/>
	        <!-- 对表单的每个控件元素，如果是输入框，且并非PLUIcombo类型组件，则应采用样式"combo"。
	        	 对表单的每个控件元素，如果是combo组件，则应设置属性"width="80""。
	         -->
	        &nbsp;项目名称：<input type="text" name="project_name" class="combo" />
