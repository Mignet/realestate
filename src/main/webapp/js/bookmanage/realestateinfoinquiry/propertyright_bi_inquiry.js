...
$(function(){
	propertyrightBILst = $('#propertyrightBILst').datagrid({
		...
		columns :[[ 
			...
			{ title : '登记单元类型',     field : 'AREG_UNIT_TYPE'   ,width:80 },
			{ title : '登记单元编号',   field : 'REG_UNIT_CODE' ,width:100 },
			{ title : '坐落',   field : 'ADDRESS'  ,width:120 },
			{ title : '转移方式',     field : 'ASHIFTMODE' ,width:60 },
			{ title : '权利人名称',   field : 'HOLDER_NAME'  ,width:80 },
			{ title : '证件号码',   field : 'HOLDER_NO'  ,width:120 },
			{ hidden:'true',field : 'BOOK_CODE' },
			{ hidden:'true',field : 'WHERE_CODE' },
			{ hidden:'true',field : 'REG_UNIT_TYPE'},
			{ hidden:'true',field : 'checked'},
			{ title : '操  作',       field:'button',formatter:function(value,rec){return '<span><input type="button" value=" 详  情 " onclick=""/></span>';},width:70}
		]],
		toolbar:'#printdiv',
