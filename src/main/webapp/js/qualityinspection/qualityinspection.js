...
window.onload = function(){
	...
	sampleDataGrid = $('#table_business').datagrid({
		...
		columns:[[
			...
			{field:'BATCH_NO', title:'抽检批次',align :'center', width:60, sortable:true},
			...
			{field:'check',title:'操作',formatter:function(value,rec){return '<span><input  type="button" value="检查" onclick=""/></span>';}}
		]],
		onClickRow : function() {
			//点击列时激活“编辑”、“删除”按钮
