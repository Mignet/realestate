...
var rec_type_flag = enumdata.REC_TYPE_FLAG.DISPACH;//材料类型   0代表接件材料   1发文材料清单
var state1 = {
		string0: "受理",
		string1 : "初审",
		string2 : "复审",
...
$(function(){  
               var lastIndex;  
        		...
        		columns:[[
        					...
        					{field:'RE_NAME', title:'发文清单名称', width:100, sortable:true,editor:'text'},	
        					...
        					{field:'RE_PERSON',	title:'发放人', width:50},
        					{field:'RE_DATE',	title:'发放日期', width:80},
...
//                	}
         ...
         jjclDataGrid = $('#tt').datagrid(jjcl);		//生成发文清单datagrid
});  
//初始化结束
